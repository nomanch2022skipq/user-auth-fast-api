...
async def create_post(title: str, content: str, token: HTTPAuthorizationCredentials = Depends(security)):
    try:
        ...
        post.created_at = datetime.datetime = datetime.datetime.now()
